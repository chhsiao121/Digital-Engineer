...
HD_PWD='C:/project/DD_project/pratice/Novatek/dff/dff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dff.tcl -notrace
